 ...
 <div class="container-fluid bg-primary p-5 bg-hero mb-5">
    <div class="row py-5">
        <div class="col-12 text-center">
            ...
            <a href="{{ route('web') }}" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
    ...
    <div class="row g-5 mb-5">
        <div class="col-lg-4">
            <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                ...
                <p class="text-secondary mb-0">Jalore, Rajasthan, India</p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                ...
                <a href="mailto:imdeepaksuthar@gmail.com"><p class="text-secondary mb-0">imdeepaksuthar@gmail.com</p></a>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                ...
                <a href="tel:9983878055"><p class="text-secondary mb-0">+91 9983878055</p></a>
            </div>
        </div>
    </div>
    <div class="row g-0">
